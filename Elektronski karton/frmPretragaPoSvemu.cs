...
{
    public partial class frmPretragaPoSvemu : Form
    {
        public frmPretragaPoSvemu()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            rows = DB.select8("SELECT ime, prezime, god_rodj, adresa, bolesti_rizika, dijagnoza, terapija, datum FROM intervencija JOIN pacijent ON pacijent.Id = intervencija.pacijent_id" +
                " WHERE ime='" + tbIme.Text + "' " +
                "AND prezime='" + tbPrezime.Text + "' " +
                "AND god_rodj ='" + tbGodRodj.Text + "' " +
                "AND adresa='" + tbAdresa.Text + "'");
        ...
        private void frmPretragaPoSvemu_FormClosing(object sender, FormClosingEventArgs e)
        {
